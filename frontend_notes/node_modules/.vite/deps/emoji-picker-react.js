...
var stylesheet = createSheet("epr");
var hidden = {
  display: "none",
  opacity: "0",
  pointerEvents: "none",
...
function useSetConfig(config) {
  ...
  (0, import_react.useEffect)(function() {
    var _config$customEmojis, _mergedConfig$customE;
    if (((_config$customEmojis = config.customEmojis) == null ? void 0 : _config$customEmojis.length) !== ((_mergedConfig$customE = mergedConfig.customEmojis) == null ? void 0 : _mergedConfig$customE.length)) {
      setMergedConfig(mergeConfig(config));
    }
  }, [(_config$customEmojis2 = config.customEmojis) == null ? void 0 : _config$customEmojis2.length]);
  return mergedConfig;
}
...
function useSkinTonesDisabledConfig() {
  var _usePickerConfig3 = usePickerConfig(), skinTonesDisabled = _usePickerConfig3.skinTonesDisabled;
  return skinTonesDisabled;
}
function useEmojiStyleConfig() {
  var _usePickerConfig4 = usePickerConfig(), emojiStyle = _usePickerConfig4.emojiStyle;
  return emojiStyle;
}
function useAutoFocusSearchConfig() {
  var _usePickerConfig5 = usePickerConfig(), autoFocusSearch = _usePickerConfig5.autoFocusSearch;
  return autoFocusSearch;
}
function useCategoriesConfig() {
  var _usePickerConfig6 = usePickerConfig(), categories = _usePickerConfig6.categories;
  return categories;
}
function useCustomEmojisConfig() {
  var _usePickerConfig7 = usePickerConfig(), customEmojis = _usePickerConfig7.customEmojis;
  return customEmojis;
}
...
function usePreviewConfig() {
  var _usePickerConfig8 = usePickerConfig(), previewConfig = _usePickerConfig8.previewConfig;
  return previewConfig;
}
function useThemeConfig() {
  var _usePickerConfig9 = usePickerConfig(), theme = _usePickerConfig9.theme;
  return theme;
}
function useSuggestedEmojisModeConfig() {
  var _usePickerConfig10 = usePickerConfig(), suggestedEmojisMode = _usePickerConfig10.suggestedEmojisMode;
  return suggestedEmojisMode;
}
function useLazyLoadEmojisConfig() {
  var _usePickerConfig11 = usePickerConfig(), lazyLoadEmojis = _usePickerConfig11.lazyLoadEmojis;
  return lazyLoadEmojis;
}
function useClassNameConfig() {
  var _usePickerConfig12 = usePickerConfig(), className = _usePickerConfig12.className;
  return className;
}
function useStyleConfig() {
  var _usePickerConfig13 = usePickerConfig(), height = _usePickerConfig13.height, width = _usePickerConfig13.width, style = _usePickerConfig13.style;
  return _extends({
...
function useReactionsOpenConfig() {
  var _usePickerConfig14 = usePickerConfig(), reactionsDefaultOpen = _usePickerConfig14.reactionsDefaultOpen;
  return reactionsDefaultOpen;
}
function useEmojiVersionConfig() {
  var _usePickerConfig15 = usePickerConfig(), emojiVersion = _usePickerConfig15.emojiVersion;
  return emojiVersion;
}
function useSearchDisabledConfig() {
  var _usePickerConfig16 = usePickerConfig(), searchDisabled = _usePickerConfig16.searchDisabled;
  return searchDisabled;
}
function useSkinTonePickerLocationConfig() {
  var _usePickerConfig17 = usePickerConfig(), skinTonePickerLocation = _usePickerConfig17.skinTonePickerLocation;
  return skinTonePickerLocation;
}
function useUnicodeToHide() {
  var _usePickerConfig18 = usePickerConfig(), unicodeToHide = _usePickerConfig18.unicodeToHide;
  return unicodeToHide;
}
function useReactionsConfig() {
  var _usePickerConfig19 = usePickerConfig(), reactions = _usePickerConfig19.reactions;
  return reactions;
}
function useGetEmojiUrlConfig() {
  var _usePickerConfig20 = usePickerConfig(), getEmojiUrl = _usePickerConfig20.getEmojiUrl;
  return getEmojiUrl;
}
...
function firstVisibleEmoji(parent) {
  ...
  return firstVisibleElementInContainer(parent, allEmojis2);
}
...
function ClickableEmojiButton(_ref) {
  ...
  return (0, import_react.createElement)(Button, {
    className: cx(styles$1.emoji, hidden2 && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch, (_cx = {}, _cx[ClassNames.visible] = !hidden2 && !hiddenOnSearch, _cx), !!(hasVariations && showVariations) && styles$1.hasVariations, noBackground && styles$1.noBackground, className),
    "data-unified": unified,
    "aria-label": emojiNames2[0],
...
function EmojiImg(_ref) {
  ...
  return (0, import_react.createElement)("img", {
    src: imgUrl,
    alt: emojiName2,
    className: cx(styles$2.emojiImag, emojiStyles.external, emojiStyles.common, className),
...
function NativeEmoji(_ref) {
  ...
  return (0, import_react.createElement)("span", {
    className: cx(styles$3.nativeEmoji, emojiStyles.common, emojiStyles.external, className),
    "data-unified": unified,
    style
...
function BtnPlus() {
  ...
  return (0, import_react.createElement)(Button, {
    ...
    tabIndex: 0,
    className: cx(styles$4.plusSign),
    onClick: function onClick() {
      return setReactionsMode(false);
    }
  });
}
var styles$4 = stylesheet.create(_extends({
  plusSign: {
    fontSize: "20px",
    padding: "17px",
...
function Reactions() {
  ...
  return (0, import_react.createElement)("ul", {
    className: cx(styles$5.list, !reactionsOpen && commonStyles.hidden),
    ref: ReactionsRef
    ...
    return (0, import_react.createElement)("li", {
      ...
      className: cx(styles$5.emojiButton),
      noBackground: true
    }));
  }), (0, import_react.createElement)("li", null, (0, import_react.createElement)(BtnPlus, null)));
}
...
function EmojiCategory(_ref) {
  ...
  return (0, import_react.createElement)("li", {
    className: cx(styles$6.category, hidden2 && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch),
    "data-name": category,
    "aria-label": categoryName
  }, (0, import_react.createElement)("h2", {
    className: cx(styles$6.label)
  }, categoryName), (0, import_react.createElement)("div", {
    className: cx(styles$6.categoryContent)
  }, children));
}
...
function EmojiList() {
  ...
  return (0, import_react.createElement)("ul", {
    className: cx(styles$7.emojiList)
    ...
    return (0, import_react.createElement)(RenderCategory, {
      key: category,
      category,
      categoryConfig,
...
function EmojiVariationPicker() {
  ...
  return (0, import_react.createElement)("div", {
    ...
    className: cx(styles$8.variationPicker, getMenuDirection() === Direction.Down && styles$8.pointingUp, visible && styles$8.visible),
    style: {
      top
    }
...
var styles$8 = stylesheet.create(_extends({
  variationPicker: {
...
function Body() {
  ...
  useOnMouseMove();
  return (0, import_react.createElement)("div", {
    className: cx(styles$9.body, commonInteractionStyles.hiddenOnReactions),
    ref: BodyRef
...
function Flex(_ref) {
  ...
  return (0, import_react.createElement)("div", {
    ...
    className: cx(styles$a.flex, className, styles$a[direction])
  }, children);
}
var styles$a = stylesheet.create((_stylesheet$create = {
  flex: {
    display: "flex"
  }
...
function BtnSkinToneVariation(_ref) {
  ...
  return (0, import_react.createElement)(Button, {
    style,
    onClick,
    className: cx("epr-tone-" + skinToneVariation, styles$b.tone, !isOpen && styles$b.closedTone, isActive && styles$b.active),
    tabIndex: isOpen ? 0 : -1,
...
function SkinTonePicker(_ref) {
  ...
  return (0, import_react.createElement)(Relative, {
    className: cx(styles$c.skinTones, vertical && styles$c.vertical, isOpen && styles$c.open, vertical && isOpen && styles$c.verticalShadow),
    style: vertical ? {
...
function Preview() {
  ...
  return (0, import_react.createElement)(Flex, {
    className: cx(styles$d.preview, commonInteractionStyles.hiddenOnReactions)
...
function CategoryButton(_ref) {
  ...
  return (0, import_react.createElement)(Button, {
    ...
    className: cx(styles$e.catBtn, commonInteractionStyles.categoryBtn, "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
    onClick,
...
var styles$e = stylesheet.create(_extends({
  catBtn: {
    ".": "epr-cat-btn",
...
function BtnClearSearch() {
  ...
  return (0, import_react.createElement)(Button, {
    className: cx(styles$g.btnClearSearch, commonInteractionStyles.visibleOnSearchOnly),
    onClick: clearSearch,
    "aria-label": "Clear",
    title: "Clear"
  }, (0, import_react.createElement)("div", {
    className: cx(styles$g.icnClearnSearch)
  }));
}
var HoverDark = {
  ":hover": {
...
var styles$g = stylesheet.create(_extends({
  btnClearSearch: {
...
function IcnSearch() {
  return (0, import_react.createElement)("div", {
    className: cx(styles$h.icnSearch)
  });
}
...
function Search() {
  ...
  return (0, import_react.createElement)(Relative, {
    className: cx(styles$i.searchContainer)
    ...
    role: "status",
    className: cx("epr-status-search-results", styles$i.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
...
function PickerMain(_ref) {
  var children = _ref.children;
  return (0, import_react.createElement)(PickerContextProvider, null, (0, import_react.createElement)(PickerStyleTag, null), (0, import_react.createElement)(PickerRootElement, null, children));
}
function PickerRootElement(_ref2) {
  ...
  return (0, import_react.createElement)("aside", {
    className: cx(styles$j.main, styles$j.baseVariables, theme === Theme.DARK && styles$j.darkTheme, theme === Theme.AUTO && styles$j.autoThemeDark, (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx), reactionsMode && styles$j.reactionsMenu, className),
    ref: PickerMainRef,
...
function EmojiPicker(props) {
  return (0, import_react.createElement)(ElementRefContextProvider, null, (0, import_react.createElement)(PickerConfigProvider, Object.assign({}, props), (0, import_react.createElement)(ContentControl, null)));
}
function ContentControl() {
  ...
  return (0, import_react.createElement)(PickerMain, null, (0, import_react.createElement)(Reactions, null), renderAll ? (0, import_react.createElement)(import_react.Fragment, null, (0, import_react.createElement)(Header, null), (0, import_react.createElement)(Body, null), (0, import_react.createElement)(Preview, null)) : null);
}
var EmojiPickerReact = (0, import_react.memo)(EmojiPicker, function(prev, next) {
